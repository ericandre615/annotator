...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = (0, _redux.combineReducers)({
	  documents: _reducers2.default.documentsReducer,
	  annotations: _reducers2.default.annotationsReducer,
	  categories: _reducers2.default.categoriesReducer
	});
	...
	if ('sessionStorage' in window) {
	  var appStorage = sessionStorage.getItem('appState');
	  if (appStorage) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _documentsReducer = __webpack_require__(179);

	var _annotationsReducer = __webpack_require__(181);

	var _categoriesReducer = __webpack_require__(182);

	exports.default = {
	  documentsReducer: _documentsReducer.documentsReducer,
	  categoriesReducer: _categoriesReducer.categoriesReducer,
	  annotationsReducer: _annotationsReducer.annotationsReducer
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.documentsReducer = undefined;
	...
	var documentsReducer = exports.documentsReducer = function documentsReducer() {
	  ...
	  switch (action.type) {
	    case _actionTypes.ADD_DOCUMENT:
	      return Object.assign({}, state, {
	        id: action.doc_id,
	        text: action.text
	      });
	    case _actionTypes.TOGGLE_HIGHLIGHTS:
	      return Object.assign({}, state, {
...
/***/ function(module, exports) {
	...
	// document actions
	var ADD_DOCUMENT = exports.ADD_DOCUMENT = 'ADD_DOCUMENT';
	// annotation actions
	var ADD_ANNOTATIONS = exports.ADD_ANNOTATIONS = 'ADD_ANNOTATIONS';
	var ADD_ANNOTATION = exports.ADD_ANNOTATION = 'ADD_ANNOTATION';
	var EDIT_ANNOTATION = exports.EDIT_ANNOTATION = 'EDIT_ANNOTATION';
	var REMOVE_ANNOTATION = exports.REMOVE_ANNOTATION = 'REMOVE_ANNOTATION';
	var FILTER_ANNOTATIONS = exports.FILTER_ANNOTATIONS = 'FILTER_ANNOTATIONS';
	var TOGGLE_HIGHLIGHTS = exports.TOGGLE_HIGHLIGHTS = 'TOGGLE_HIGHLIGHTS';
	// category actions
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.annotationsReducer = undefined;
	...
	var annotationsReducer = exports.annotationsReducer = function annotationsReducer() {
	  ...
	  switch (action.type) {
	    case _actionTypes.ADD_ANNOTATIONS:
	      var newAnnotations = [];
	      newAnnotations.concat.apply(newAnnotations, _toConsumableArray(state));
	      action.annotations.forEach(function (annotation, i) {
	        newAnnotations.push(annotation);
	      });
	      return newAnnotations;
	    case _actionTypes.REMOVE_ANNOTATION:
	      return state.filter(function (annotation, i) {
	        if (annotation.id !== action.id) {
	          return annotation;
	        }
	      });
	    case _actionTypes.EDIT_ANNOTATION:
	      return state.map(function (annotation, i) {
	        if (annotation.id !== action.id) {
	          return annotation;
	        }
	...
	exports.default = {
	  annotationsReducer: annotationsReducer
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.categoriesReducer = undefined;
	...
	var categoriesReducer = exports.categoriesReducer = function categoriesReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case _actionTypes.ADD_CATEGORY:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _document = __webpack_require__(189);
	...
	var App = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    (0, _annotations3.getAnnotations)().then(function (response) {
	      doc_id = response.data.document.attr.DOCID;

	      var annotations = response.data.document.span.map(function (annotation, i) {
	        annotation.id = response.data.document.attr.DOCID + '-' + annotation.extent.charseq.attr.START;
	        _this.props.addCategory(annotation.attr.category);
	        return annotation;
	      });

	      _this.props.addAnnotations(annotations);

	      return (0, _documents.getDocument)(doc_id);
	    }).then(function (doc) {
	      return _this.props.addDocument(doc_id, doc.data);
	  ...
	  handleSaveState: function handleSaveState(e) {
	    var savedAnnotations = {
	      document: {
	        ...
	        span: this.props.annotations.map(function (annotation, i) {
	          return {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'btn btn-sm toggle-status ' + (this.props.documents.highlights ? 'active' : '') },
	            this.props.documents.highlights ? 'on' : 'off'
	          ),
	          _react2.default.createElement(
	            'button',
	            {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    addDocument: function addDocument(doc_id, text, annotations) {
	      return dispatch((0, _documentsActions.addDocument)(doc_id, text, annotations));
	    },
	    addAnnotations: function addAnnotations(annotations) {
	      return dispatch((0, _annotationsActions.addAnnotations)(annotations));
	    },
	    editAnnotation: function (_editAnnotation) {
	      function editAnnotation(_x, _x2) {
	        return _editAnnotation.apply(this, arguments);
	      }

	      editAnnotation.toString = function () {
	        return _editAnnotation.toString();
	      };

	      return editAnnotation;
	    }(function (id, category) {
	      return dispatch(editAnnotation(id, category));
	    }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./header.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./header.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "header[role=\"banner\"] {\n  width: 100%;\n  background-color: #7A7E8D;\n  padding: 1em;\n  margin-bottom: 2em;\n}\nheader[role=\"banner\"] h1 {\n  font-size: 2em;\n  color: white;\n  margin: 0;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Document = _react2.default.createClass({
	  ...
	  propTypes: {
	    document: _react2.default.PropTypes.string.isRequired,
	    annotations: _react2.default.PropTypes.array
	  },
	  ...
	  render: function render() {
	    var annotated = (0, _highlighter.highlightAnnotations)(this.props.document, this.props.annotations, 1);
	    ...
	    return _react2.default.createElement(
	      ...
	      this.state.showModal ? _react2.default.createElement(
	        ...
	        _react2.default.createElement(_annotation2.default, { annotation: this.state.showAnnotation.annotation })
	      ) : false,
	      _react2.default.createElement('pre', { className: 'document col-xs-12 col-md-8 ' + (this.props.highlights ? 'highlights' : ''),
...
/***/ function(module, exports) {
	...
	var highlightAnnotations = exports.highlightAnnotations = function highlightAnnotations() {
	  ...
	  var highlighted = '';
	  var tempAnnotations = [].concat(annotations);

	  var _loop = function _loop(cursor) {
	    if (cursor > 0) {
	      highlighted += doc[cursor];
	    }
	    tempAnnotations.some(function (annotation, i) {
	      var start = annotation.extent.charseq.attr.START;
	      var end = annotation.extent.charseq.attr.END;
	      var category = annotation.attr.category;
	  ...
	  for (var cursor = 0; cursor < doc.length; cursor++) {
	    _loop(cursor);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Annotation = _react2.default.createClass({
	  displayName: 'Annotation',

	  propType: {
	    annotation: _react2.default.PropTypes.object.isRequired
	  },

	  handleRemove: function handleRemove(e) {
	    var annotation_id = e.target.dataset.id;
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'annotation', key: this.props.annotation.id },
	      _react2.default.createElement(
	        'span',
	        { className: 'annotation' },
	        this.props.annotation.extent.charseq.text,
	        ' '
	      ),
	      _react2.default.createElement(
	        'select',
	      ...
	      _react2.default.createElement(
	        'button',
	        { className: 'btn btn-danger', onClick: this.handleRemove, 'data-id': this.props.annotation.id },
	        'remove'
	      )
	    );
	  }
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    removeAnnotation: function removeAnnotation(id) {
	      return dispatch((0, _annotationsActions.removeAnnotation)(id));
	    },
	    editAnnotation: function editAnnotation(id, category) {
	      return dispatch((0, _annotationsActions.editAnnotation)(id, category));
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.removeAnnotation = exports.editAnnotation = exports.addAnnotation = exports.addAnnotations = undefined;

	var _actionTypes = __webpack_require__(180);

	var addAnnotations = exports.addAnnotations = function addAnnotations() {
	  var annotations = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

	  return {
	    type: _actionTypes.ADD_ANNOTATIONS,
	    annotations: annotations
	  };
	};

	var addAnnotation = exports.addAnnotation = function addAnnotation() {
	  var annotation = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	  return {
	    type: _actionTypes.ADD_ANNOTATION,
	    annotation: annotation
	  };
	};

	var editAnnotation = exports.editAnnotation = function editAnnotation(id, category) {
	  return {
	    type: _actionTypes.EDIT_ANNOTATION,
	    id: id,
	    category: category
	  };
	};

	var removeAnnotation = exports.removeAnnotation = function removeAnnotation(id) {
	  return {
	    type: _actionTypes.REMOVE_ANNOTATION,
	    id: id
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./document.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./document.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".document mark {\n  background: none;\n}\n.document mark:hover {\n  cursor: pointer;\n}\n.document.highlights mark {\n  background-color: yellow;\n}\n.document.highlights .location {\n  background-color: #5DF292;\n}\n.document.highlights .person {\n  background-color: #8BFCD6;\n}\n.document.highlights .organization {\n  background-color: #6495ED;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Annotations = _react2.default.createClass({
	  displayName: 'Annotations',

	  propTypes: {
	    annotations: _react2.default.PropTypes.array.isRequired
	  },
	  ...
	  render: function render() {
	    var annotations = this.props.annotations.map(function (annotation, index) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_annotation2.default, { key: annotation.id,
	          annotation: annotation
	        })
	      );
	    });
	    return _react2.default.createElement(
	      'ul',
	      { className: 'annotations col-xs-12 col-md-4' },
	      annotations
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./annotations.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../../../node_modules/less-loader/index.js!./annotations.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAnnotations = exports.getAnnotations = function getAnnotations() {
	  return _axios2.default.get('/annotations');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDocument = exports.getDocument = function getDocument() {
	  var doc_id = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];

	  return _axios2.default.get('/documents/' + doc_id);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.toggleHighlights = exports.addDocument = undefined;

	var _actionTypes = __webpack_require__(180);

	var addDocument = exports.addDocument = function addDocument(doc_id) {
	  var text = arguments.length <= 1 || arguments[1] === undefined ? '' : arguments[1];

	  return {
	    type: _actionTypes.ADD_DOCUMENT,
	    doc_id: doc_id,
	    text: text
	  };
	};

	var toggleHighlights = exports.toggleHighlights = function toggleHighlights() {
	  return {
	    type: _actionTypes.TOGGLE_HIGHLIGHTS
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addCategory = exports.addCategory = function addCategory() {
	  ...
	  return {
	    type: _actionTypes.ADD_CATEGORY,
	    category: category
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../node_modules/less-loader/index.js!./app.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?{browsers: [\"last 3 versions\", \"safari 5\", \"ie 8\", \"ie 9\", \"opera 12.1\", \"ios 6\", \"android 4\"]}!./../node_modules/less-loader/index.js!./app.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
